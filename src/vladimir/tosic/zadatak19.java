...
public class zadatak19 {
	...
	public static void main(String[] args) throws Exception {
		// q0 - trougaono opterecenje // L - duzina grede // m - napadni moment 
		...
		{
			ft = q0 * (L / 3.0 - z * z / L) / 2.0; m = q0 * L * L * (z / L - Math.pow(z/L, 3.0)) / 6.0; System.out.println("\t" + df.format(z) + "\t" + df.format(ft) + "\t" + df.format(m)); 
			}
